...
/**
 * 
 *           Requests the firmware service to return the status of the firmware update for the given device sgtin.
 *         
 * 
 * <p>Java-Klasse für device_firmware_update_status_get_request complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="device_firmware_update_status_get_request">
 *   &lt;complexContent>
...
@XmlType(name = "device_firmware_update_status_get_request", propOrder = {
    "deviceSgtin"
})
public class DeviceFirmwareUpdateStatusGetRequest {
