...
/**
 * 
 *                 Requests the firmware service to delete all metadata and S3 files tagged with the requested firmware label.
 *             
 * 
 * <p>Java-Klasse für device_firmware_rule_delete_request complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="device_firmware_rule_delete_request">
 *   &lt;complexContent>
...
@XmlType(name = "device_firmware_rule_delete_request", propOrder = {
    "firmwareLabel"
})
public class DeviceFirmwareRuleDeleteRequest {
