...
/**
 * 
 *                 Event fired by the forwarding service when an error occures during encryption/decryption of LsBL messages
 *             
 * 
 * <p>Java-Klasse für error_payload_crypt_event complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="error_payload_crypt_event">
 *   &lt;complexContent>
...
@XmlType(name = "error_payload_crypt_event", propOrder = {
    "source",
    "errorCode",
    "message",
    "clientAdr",
...
public class ErrorPayloadCryptEvent {
