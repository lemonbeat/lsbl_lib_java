...
/**
 * 
 *           Event fired by the metadata service to inform about a successful device exclusion.
 *         
 * 
 * <p>Java-Klasse für metadata_device_excluded_event complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="metadata_device_excluded_event">
 *   &lt;complexContent>
...
@XmlType(name = "metadata_device_excluded_event", propOrder = {
    "uuid",
    "deviceSgtin",
    "gwSgtin",
    "metadataReport",
...
public class MetadataDeviceExcludedEvent {
