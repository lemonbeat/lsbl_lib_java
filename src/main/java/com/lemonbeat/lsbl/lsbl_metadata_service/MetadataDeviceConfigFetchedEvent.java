 ...
 *         
 * 
 * <p>Java-Klasse für metadata_device_config_fetched_event complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="metadata_device_config_fetched_event">
 *   &lt;complexContent>
...
@XmlType(name = "metadata_device_config_fetched_event", propOrder = {
    "uuid",
    "deviceSgtin",
    "gwSgtin"
})
public class MetadataDeviceConfigFetchedEvent {
