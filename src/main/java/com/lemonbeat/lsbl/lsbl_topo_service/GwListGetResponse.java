...
/**
 * 
 * 				Response for the request of a list of all included gateways. The gateways are ordered by the SGTINs of the gateway.
 * 			
 * 
 * <p>Java-Klasse f�r gw_list_get_response complex type.
 * 
