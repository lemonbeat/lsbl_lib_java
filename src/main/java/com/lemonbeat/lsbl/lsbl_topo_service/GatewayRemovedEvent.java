...
/**
 * 
 *         Event fired by the topo_service to inform about a removed gateway.
 *       
 * 
 * <p>Java-Klasse für gateway_removed_event complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="gateway_removed_event">
 *   &lt;complexContent>
...
@XmlType(name = "gateway_removed_event", propOrder = {
    "gwSgtin"
})
public class GatewayRemovedEvent {
