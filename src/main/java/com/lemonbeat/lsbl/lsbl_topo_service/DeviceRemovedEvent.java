...
/**
 * 
 *         Event fired by the topo_service to inform about a removed device.
 *       
 * 
 * <p>Java-Klasse für device_removed_event complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="device_removed_event">
 *   &lt;complexContent>
...
@XmlType(name = "device_removed_event", propOrder = {
    "deviceSgtin"
})
