...
/**
 * 
 *                 Requests the TopologyService to query the global_key_service for inclusion data and send the include LsDL device message to the gateway.
 *             
 * 
 * <p>Java-Klasse f�r device_include_request complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="device_include_request">
 *   &lt;complexContent>
...
@XmlType(name = "device_include_request", propOrder = {
    "gwSgtin",
    "deviceSgtin"
})
public class DeviceIncludeRequest {
