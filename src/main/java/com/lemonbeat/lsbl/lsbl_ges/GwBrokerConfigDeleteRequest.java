...
/**
 * 
 *         Requests the Ges Interface to remove the AMQP Configuration on the Customerfacade broker for a Gateway,
 *         specified by its SGTIN.
 *       
 * 
 * <p>Java-Klasse für gw_broker_config_delete_request complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="gw_broker_config_delete_request">
 *   &lt;complexContent>
...
@XmlType(name = "gw_broker_config_delete_request", propOrder = {
    "gwSgtin"
})
public class GwBrokerConfigDeleteRequest {
